...
import {
    HamburgerIcon,
    HomeIcon,
    SmallBlogIcon, SmallContributeIcon,
    SmallHomeIcon,
    SmallMerchIcon,
    SmallMusicIcon
    ...
    return (
        ...
        <nav className={' navBlur px-8 py-8 md:py-6 md:px-0 mx-auto animate__animated animate__slideInDown animate__slower animate__delay-4s fixed top-0 w-full z-50'}>
            <div className={' w-full md:hidden flex flex-col'}>
                ...
                {/*Mobile Modal*/}
                {show &&
                    <div className={'coming z-50 h-svh flex justify-center items-center pb-44 sticky modal'}>
                        <ul className={'list-none flex flex-col gap-8 absolute'}>
                            <Link href={'/'}>
                                <li className={'navItem hover:underline'} onClick={closeMenu}>
                                <span>Home</span>
                                    <SmallHomeIcon />
                                </li>
                            </Link>
            ...
            <ul className={'coming w-full hidden md:flex justify-evenly'}>
                <Link href={'/'}>

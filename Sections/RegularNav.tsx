...
export default function RegularNav() {
    ...
    return (
        <nav
            className={' px-4 py-4 md:py-6 md:px-0 mx-auto relative'}>
            <div className={' w-full md:hidden flex flex-col'}>
                ...
                <div className={' md:hidden cursor-pointer flex justify-between'} >
                    <Link href={'/'}>
                        ...
                        <svg onClick={() => setShow(!show)} xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <ul className={'w-full hidden md:flex justify-evenly'}>
                <Link href={'/music'}>
                    <li className={'navItem'}>
                        <span>Music</span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
